...
export default function ProductOrderCard({ product, priceType }) {
  const { bump, handleExactQty } = usePosContext();
  ...
  return (
    <article className="product-card">
      ...
      <div className="qty-row">
        ...
        <input className="qty-input" inputMode="numeric" min="0" onChange={(e) => handleExactQty(normalized.id, e.target.value)} type="number" value={qty || ""} placeholder="0" />
